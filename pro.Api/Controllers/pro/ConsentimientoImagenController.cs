...
namespace pro.Api.Controllers
{
    ...
    [ApiController]
    public class ConsentimientoImagenController : Controller
    {
        private readonly LConsentimientoImagen _logic;
        private readonly MResponse _response;

        public ConsentimientoImagenController(DBPRO dbc, IOptions<MConfiguracion> option)
        {
            _logic = new LConsentimientoImagen(dbc, option);
            _response = new MResponse();
        }

        [HttpGet("[action]")]
        public async Task<IActionResult> Get([Required] int option, [FromQuery] MConsentimientoImagen model)
        {
            try
            {
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Put(int option, MConsentimientoImagen model)
        {
            try
            {
        ...
        [HttpDelete("[action]")]
        public async Task<IActionResult> Delete(int option, List<MConsentimientoImagen> model)
        {
            try
            {
        ...
        [HttpGet("[action]")]
        public async Task<IActionResult> ConsentImage([FromQuery] string archivo)
        {
            try
            {
