...
namespace pro.Api.Controllers
{
    ...
    [ApiController]
    public class PagoImagenController : Controller
    {
        private readonly LPagoImagen _logic;
        private readonly MResponse _response;

        public PagoImagenController(DBPRO dbc, IOptions<MConfiguracion> option)
        {
            _logic = new LPagoImagen(dbc, option);
            _response = new MResponse();
        }

        [HttpGet("[action]")]
        public async Task<IActionResult> Get([Required] int option, [FromQuery] MPagoImagen model)
        {
            try
            {
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Put(int option, MPagoImagen model)
        {
            try
            {
        ...
        [HttpDelete("[action]")]
        public async Task<IActionResult> Delete(int option, List<MPagoImagen> model)
        {
            try
            {
        ...
        [HttpGet("[action]")]
        public async Task<IActionResult> PaymentImage([FromQuery] string archivo)
        {
            try
            {
