...
namespace pro.Api.Controllers.pro
{
    ...
    public class RolController : Controller
    {
        ...
        public RolController(DBPRO dbc)
        {
            _logic = new LRol(dbc);
        ...
        [HttpGet("[action]")]
        public async Task<IActionResult> Get([Required] int option, [FromQuery] MRol model)
        {
            try
            {
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Put(int option, MRol model)
        {
            try
            {
        ...
        [HttpDelete("[action]")]
        public async Task<IActionResult> Delete(int option, List<MRol> model)
        {
            try
            {
