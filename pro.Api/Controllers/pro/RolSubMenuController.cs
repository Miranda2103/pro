...
namespace pro.Api.Controllers
{
    ...
    public class RolSubMenuController : Controller
    {
        ...
        public RolSubMenuController(DBPRO dbc)
        {
            _logic = new LRolSubMenu(dbc);
            _response = new MResponse();
        }

        [HttpGet("[action]")]
        public async Task<IActionResult> Get([Required] int option, [FromQuery] MRolSubMenu model)
        {
            try
            {
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Put(int option, MRolSubMenu model)
        {
            try
            {
        ...
        [HttpDelete("[action]")]
        public async Task<IActionResult> Delete(int option, List<MRolSubMenu> model)
        {
            try
            {
