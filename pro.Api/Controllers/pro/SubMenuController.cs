...
namespace pro.Api.Controllers.pro
{
    ...
    public class SubMenuController : Controller
    {
        ...
        public SubMenuController(DBPRO dbc)
        {
            _logic = new LSubMenu(dbc);
            _response = new MResponse();
        }

        [HttpGet("[action]")]
        public async Task<IActionResult> Get([Required] int option, [FromQuery] MSubMenu model)
        {
            try
            {
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Put(int option, MSubMenu model)
        {
            try
            {
        ...
        [HttpDelete("[action]")]
        public async Task<IActionResult> Delete(int option, List<MSubMenu> model)
        {
            try
            {
